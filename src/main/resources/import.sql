...
insert into boardgames(name, min_players, max_players, min_age, bg_year, bgg) values('xxxxxxxx',1,8,14,2014,'https://boardgamegeek.com/boardgame');
insert into publishers(name, web, country) values('yyyy','www.yyyy.com','france');
insert into boardgames_designers(games_id, designers_id) values(5,3);
insert into boardgames_publishers(games_id, publishers_id) values(5,4);